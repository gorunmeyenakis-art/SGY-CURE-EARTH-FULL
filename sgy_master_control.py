...
def main():
    while True:
        ...
        print("  [6] OTONOM TAM PIPELINE EXECUTION & GIT PUSH")
        print("  [0] Çıkış")
        print("=======================================================================")
        ...
        if c == '1': os.system('python3 sgy_cure_earth_hud.py')
            ...
            os.system('python3 sgy_ai_qec_core.py && python3 sgy_pqc_hardware_core.py && python3 sgy_hil_dsn_core.py && python3 sgy_planetary_rf_core.py')
            os.system('git add . && git commit -m "feat: integrated planetary atmospheric RF core and updated orchestrator" && git push origin main')
        elif c == '0': break
