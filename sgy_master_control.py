...
def main():
    while True:
        os.system('clear')
        print("=======================================================================")
        print("      SGY-CURE-EARTH-FULL | MASTER KARARGAH KONTROL MERKEZİ v4.0       ")
        print("=======================================================================")
        ...
        print("  [7] C++ NASA Autonomous Cosmic Control v4.0 (CCSDS Stack)")
        ...
        elif c == '7': os.system('python3 sgy_nasa_v4_core.py')
        elif c == '8':
            os.system('python3 sgy_ai_qec_core.py && python3 sgy_pqc_hardware_core.py && python3 sgy_hil_dsn_core.py && python3 sgy_planetary_rf_core.py && python3 sgy_cosmos_cpp_core.py && python3 sgy_nasa_v4_core.py')
            os.system('git add . && git commit -m "feat: integrated NASA v4.0 C++ core with CCSDS packetizer and full pipeline" && git push origin main')
        elif c == '0': break
